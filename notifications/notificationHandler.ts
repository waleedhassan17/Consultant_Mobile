...
export class NotificationService {
  ...
  // Helper to get display-friendly user type name
  private static getUserTypeDisplay(userType: UserTypeValue): string {
    const displayNames: Record<UserTypeValue, string> = {
      'user': 'User',
  ...
  static async sendSignInSuccessNotification(userType: UserTypeValue): Promise<void> {
